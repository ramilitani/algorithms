...
public class DijkstraMain {
    ...
    private void addLane(String laneId, int sourceLocNo, int descLocNo, int duration) {
        Edge lane = new Edge(laneId, nodes.get(sourceLocNo), nodes.get(descLocNo), duration);
        edges.add(lane);
    }
}
